		...
		<header className='sticky-top bg-primary'>
			<div className='container-fluid d-flex justify-content-between align-items-center py-3'>
				...
				<div className='logo-container ' style={{ width: '33%' }}>
					<Link to='/'>
						<img
							src={'/logos/Viktorsshop-comic.png'}
							alt='Website Logo'
							width='250'
						/>
					</Link>
				...
				<div
					className='cart-container d-flex justify-content-end'
					style={{ width: '33%' }}
				...
				>
					...
					{cartNum > 0 ? (
						<span
							className={
								'rounded-5 bg-secondary d-flex justify-content-center align-items-center p-2'
							}
							style={{
								width: '20px',
								height: '20px',
